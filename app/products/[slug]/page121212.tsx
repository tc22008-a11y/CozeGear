  ...
  return (
    <SiteShell>
      ...
      <section className="bg-white py-10 lg:py-14">
        <div className="product-detail-shell grid gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(360px,0.8fr)] lg:items-start xl:gap-10">
          ...
          <aside className="lg:sticky lg:top-28">
           ...
           {/* 开始支付图标栏可以在这里加代码：无框、尺寸缩小 */}

{/* 三大服务模块：仅中间竖分隔、无外边框、图标文字缩小 */}
<div className="mt-4 grid grid-cols-1 divide-y md:grid-cols-3 md:divide-x md:divide-y-0">
  <div className="py-4 px-2 text-center">
    <svg className="mx-auto mb-2 text-[var(--foreground)]" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2">
      <circle cx="12" cy="12" r="10"/>
      <path d="M8 12s1.5 2 4 2 4-2 4-2"/>
    </svg>
    <p className="text-xs text-[var(--muted)] leading-relaxed">
      Recommended by<br/>+25,000 satisfied customers
    </p>
  </div>
  <div className="py-4 px-2 text-center">
    <svg className="mx-auto mb-2 text-[var(--foreground)]" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2">
      <path d="M4 8L12 4l8 4v12l-8 4-8-4z"/>
      <path d="M12 4v16M8 12l8-4M8 16l8-4"/>
    </svg>
    <p className="text-xs text-[var(--muted)] leading-relaxed">
      Free Shipping on<br/>orders &gt;50USD
    </p>
  </div>
  <div className="py-4 px-2 text-center">
    <svg className="mx-auto mb-2 text-[var(--foreground)]" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2">
      <path d="M12 2l8 4v6c0 5-3.5 8-8 9-4.5-1-8-4-8-9V6l8-4z"/>
      <path d="M9 12l2 2 4-4"/>
    </svg>
    <p className="text-xs text-[var(--muted)] leading-relaxed">
      30-day satisfaction guarantee - try the product at home
    </p>
  </div>
</div>
           {/* 结束支付图标栏：无框、尺寸缩小 */}
      ...
      <section className="bg-white py-16">
        <div className="section-shell grid gap-10 lg:grid-cols-[1.9fr_0.1fr]">
